...
class DesktopPermissions extends StatefulWidget {
  const DesktopPermissions({Key? key}) : super(key: key);

  @override
  State<DesktopPermissions> createState() => _DesktopPermissionsState();
}

class _DesktopPermissionsState extends State<DesktopPermissions> {
