...
class MobileInteractions extends StatefulWidget {
  const MobileInteractions({Key? key}) : super(key: key);

  @override
  State<MobileInteractions> createState() => _MobileInteractionsState();
}

class _MobileInteractionsState extends State<MobileInteractions> {
