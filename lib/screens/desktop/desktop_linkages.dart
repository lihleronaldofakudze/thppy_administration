...
class DesktopLinkages extends StatefulWidget {
  const DesktopLinkages({Key? key}) : super(key: key);

  @override
  State<DesktopLinkages> createState() => _DesktopLinkagesState();
}

class _DesktopLinkagesState extends State<DesktopLinkages> {
