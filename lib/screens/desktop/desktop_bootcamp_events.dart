...
class DesktopBootcampEvents extends StatefulWidget {
  const DesktopBootcampEvents({Key? key}) : super(key: key);

  @override
  State<DesktopBootcampEvents> createState() => _DesktopBootcampEventsState();
}

class _DesktopBootcampEventsState extends State<DesktopBootcampEvents> {
