...
class MobilePartners extends StatefulWidget {
  const MobilePartners({Key? key}) : super(key: key);

  @override
  State<MobilePartners> createState() => _MobilePartnersState();
}

class _MobilePartnersState extends State<MobilePartners> {
