...
class DesktopSocialMediaAnalysis extends StatefulWidget {
  const DesktopSocialMediaAnalysis({Key? key}) : super(key: key);

  @override
  State<DesktopSocialMediaAnalysis> createState() =>
      _DesktopSocialMediaAnalysisState();
}

class _DesktopSocialMediaAnalysisState
    extends State<DesktopSocialMediaAnalysis> {
