...
class DesktopSocialMedia extends StatefulWidget {
  const DesktopSocialMedia({Key? key}) : super(key: key);

  @override
  State<DesktopSocialMedia> createState() => _DesktopSocialMediaState();
}

class _DesktopSocialMediaState extends State<DesktopSocialMedia> {
