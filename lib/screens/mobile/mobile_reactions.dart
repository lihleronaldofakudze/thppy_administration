...
class MobileReactions extends StatefulWidget {
  const MobileReactions({Key? key}) : super(key: key);

  @override
  State<MobileReactions> createState() => _MobileReactionsState();
}

class _MobileReactionsState extends State<MobileReactions> {
