...
class DesktopPartners extends StatefulWidget {
  const DesktopPartners({Key? key}) : super(key: key);

  @override
  State<DesktopPartners> createState() => _DesktopPartnersState();
}

class _DesktopPartnersState extends State<DesktopPartners> {
