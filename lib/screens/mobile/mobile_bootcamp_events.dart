...
class MobileBootcampEvents extends StatefulWidget {
  const MobileBootcampEvents({Key? key}) : super(key: key);

  @override
  State<MobileBootcampEvents> createState() => _MobileBootcampEventsState();
}

class _MobileBootcampEventsState extends State<MobileBootcampEvents> {
