...
class DesktopBlogs extends StatefulWidget {
  const DesktopBlogs({Key? key}) : super(key: key);

  @override
  State<DesktopBlogs> createState() => _DesktopBlogsState();
}

class _DesktopBlogsState extends State<DesktopBlogs> {
