...
class MobileLinkages extends StatefulWidget {
  const MobileLinkages({Key? key}) : super(key: key);

  @override
  State<MobileLinkages> createState() => _MobileLinkagesState();
}

class _MobileLinkagesState extends State<MobileLinkages> {
