...
class MobileSocialMediaAnalysis extends StatefulWidget {
  const MobileSocialMediaAnalysis({Key? key}) : super(key: key);

  @override
  State<MobileSocialMediaAnalysis> createState() =>
      _MobileSocialMediaAnalysisState();
}

class _MobileSocialMediaAnalysisState extends State<MobileSocialMediaAnalysis> {
