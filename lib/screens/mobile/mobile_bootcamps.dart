...
class MobileBootcamps extends StatefulWidget {
  const MobileBootcamps({Key? key}) : super(key: key);

  @override
  State<MobileBootcamps> createState() => _MobileBootcampsState();
}

class _MobileBootcampsState extends State<MobileBootcamps> {
