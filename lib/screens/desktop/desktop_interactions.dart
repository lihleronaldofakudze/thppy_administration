...
class DesktopInteractions extends StatefulWidget {
  const DesktopInteractions({Key? key}) : super(key: key);

  @override
  State<DesktopInteractions> createState() => _DesktopInteractionsState();
}

class _DesktopInteractionsState extends State<DesktopInteractions> {
