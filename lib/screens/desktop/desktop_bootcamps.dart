...
class DesktopBootcamps extends StatefulWidget {
  const DesktopBootcamps({Key? key}) : super(key: key);

  @override
  State<DesktopBootcamps> createState() => _DesktopBootcampsState();
}

class _DesktopBootcampsState extends State<DesktopBootcamps> {
