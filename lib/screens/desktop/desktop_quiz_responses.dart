...
class DesktopQuizResponses extends StatefulWidget {
  const DesktopQuizResponses({Key? key}) : super(key: key);

  @override
  State<DesktopQuizResponses> createState() => _DesktopQuizResponsesState();
}

class _DesktopQuizResponsesState extends State<DesktopQuizResponses> {
