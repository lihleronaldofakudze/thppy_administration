...
class MobileMedia extends StatefulWidget {
  const MobileMedia({Key? key}) : super(key: key);

  @override
  State<MobileMedia> createState() => _MobileMediaState();
}

class _MobileMediaState extends State<MobileMedia> {
